"""End-to-end NUX integration tests (v3 subset).

Verifies that quality nudge and status banner work together coherently:
...
Note: setup wizard tests are omitted (deferred in v3).
"""
...
from lib import quality_nudge, ui
