...
class RerankV3Tests(unittest.TestCase):
    ...
    def test_missing_engagement_does_not_create_penalty(self):
        ...
        score_without_engagement = rerank._final_score(candidate)
        candidate.engagement = 50
        score_with_engagement = rerank._final_score(candidate)
        self.assertEqual(score_without_engagement, score_with_engagement)
